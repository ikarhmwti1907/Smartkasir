...
<div class="container mt-4">
    <!-- Filter Bulan -->
    <form action="{{ route('laporan.barang') }}" method="GET" class="mb-3 d-flex gap-2 align-items-center">
        <label class="mb-0 fw-semibold">Pilih Bulan:</label>
        <input type="month" id="filterBulan" name="bulan" class="form-control w-auto" value="{{ $bulan }}">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle text-center">
                    ...
                    <tbody>
                        ...
                        $jumlah_terjual = $b->details->sum('jumlah');
                        @endphp
                        <tr>
                            ...
                            <td class="text-dark fw-semibold">Rp {{ number_format($harga_pcs,0,',','.') }}</td>
                            <td class="text-dark fw-semibold">Rp {{ number_format($harga_lusin,0,',','.') }}</td>
                            <td class="text-dark fw-semibold">Rp {{ number_format($harga_rol,0,',','.') }}</td>
                        </tr>
                        @empty
                        <tr>
